...
import br.edu.infnet.appatnicole.model.repository.IPedidoRepository;
...
public class PedidoService {
	...
	public List<Pedido> obterLista(Usuario usuario){
		...
		return (List<Pedido>)pedidoRepository.obterLista(usuario.getId(), Sort.by(Sort.Direction.ASC, "especialidade"));
	}
